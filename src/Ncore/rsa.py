...
server_public_keys = {
    0xc3b42b026ce86b21 - 18446744073709551616: (  # Telegram servers #1
        int(
    ...
    0x10bc35f3509f7b7a5 - 18446744073709551616: (  # Telegram servers #2
        int(
    ...
    0x115ae5fa8b5529542 - 18446744073709551616: (  # Telegram servers #3
        int(
    ...
    0xaeae98e13cd7f94f - 18446744073709551616: (  # Telegram servers #4
        int(
    ...
    0x15a181b2235057d98 - 18446744073709551616: (  # Telegram servers #5
        int(
    ...
    0x995effd323b5db80 - 18446744073709551616: (  # CDN DC-121
        int(
    ...
    0x1254672538e935938 - 18446744073709551616: (  # CDN DC-140
        int(
    ...
    0xc884b3e62d09e5c5 - 18446744073709551616: (  # CDN DC-201
        int(
    ...
    0xbb27580fd5b01626 - 18446744073709551616: (  # CDN DC-203
        int(
...
def encrypt(data: bytes, fingerprint: int) -> bytes:
    return pow(
        ...
        server_public_keys[fingerprint][1],
        server_public_keys[fingerprint][0]
    ).to_bytes(256, "big")