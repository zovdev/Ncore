...
class UpdateNewMessage:
    """
    UpdateNewMessage для событий нового сообщения
    UpdateNewMessage.peer_id - Вернёт id чата события
    UpdateNewMessage.answer - Отправит сообщение в чат события
    Доступ к обновлению UpdateNewMessage.update
    Полное событие UpdateNewMessage.raw_update
    Доступ к экземпляру клиента UpdateNewMessage.client
    """
