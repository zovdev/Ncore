...
* 🔒 **Нативная поддержка прокси**: SOCKS5, HTTP, MTProxy (classic/dd/ee) с Fake-TLS, WebProxy — прямо "из коробки".
...
**Сборка:**
Для компиляции модуля `tl` и `ncrypto` используется **Cython** (Apache 2.0).
